# Simple Icons Stream Deck
 ...
 Updated to Simple Icons Version: 13.15.0
...
If you would like to propose an improvement to the generation script, please create an [issue here](https://github.com/mackenly/simple-icons-stream-deck/issues) first to discuss the changes. Docs for creating icon packs can be found [here](https://docs.elgato.com/sdk/icon-packs/overview).
